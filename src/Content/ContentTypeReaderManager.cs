				...
				for (int i = 0; i < numberOfReaders; i += 1)
				{
					...
					else
					{
						...
						readerTypeString = readerTypeString
							.Replace("Microsoft.Xna.Framework.Vector2, TNA, Version=23.2.0.0, Culture=neutral, PublicKeyToken=null", typeof(Vector2).AssemblyQualifiedName)
							.Replace("Microsoft.Xna.Framework.Vector3, TNA, Version=23.2.0.0, Culture=neutral, PublicKeyToken=null", typeof(Vector3).AssemblyQualifiedName)
							.Replace("Microsoft.Xna.Framework.Vector4, TNA, Version=23.2.0.0, Culture=neutral, PublicKeyToken=null", typeof(Vector4).AssemblyQualifiedName);
